# =============================================================================
# nuitka-build.ps1 - File Converter build pipeline
...
#   File Converter   - your project (cosmetic, used in build banner)
...
Write-Host ""
Write-Host "=== File Converter - Nuitka build ===" -ForegroundColor Cyan
Write-Host ""
...
Build-Exe "$ROOT\main.py" "OmniConvert.exe" $guiArgs
